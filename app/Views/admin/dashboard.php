        ...
        <main class="app-main" style="padding: 0;">
            <div style="max-width: 100%; margin: 0; padding: 1rem;">
                ...
                <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 1rem;">
                    <a href="index.php?route=/admin/users" style="display: block; text-decoration: none; color: inherit;">
                    ...
                    <a href="index.php?route=/admin/vendedores" style="display: block; text-decoration: none; color: inherit;">
                        <div style="background: var(--bg-tertiary); border: 1px solid var(--border-secondary); border-radius: var(--radius-sm); padding: 1.5rem; transition: all var(--transition-fast); cursor: pointer; text-align: center;">
                    ...
                    <a href="index.php?route=/admin/logistics" style="display: block; text-decoration: none; color: inherit;">
                        <div style="background: var(--bg-tertiary); border: 1px solid var(--border-secondary); border-radius: var(--radius-sm); padding: 1.5rem; transition: all var(--transition-fast); cursor: pointer; text-align: center;">
                    ...
                    <a href="index.php?route=/forms" style="display: block; text-decoration: none; color: inherit;">
                        <div style="background: var(--bg-tertiary); border: 1px solid var(--border-secondary); border-radius: var(--radius-sm); padding: 1.5rem; transition: all var(--transition-fast); cursor: pointer; text-align: center;">
